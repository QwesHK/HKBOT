...
//
const BotName = 'BOT QwesHK'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/QwesHK'; // Nama Instagramlu cok
const whatsapplu = '083807449268'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'Ntah'; // OFFICIAL GRUP LU 1
const grupch2 = 'Ntah'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
